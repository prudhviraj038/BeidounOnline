							...
							GraphRequest request = GraphRequest.newMeRequest(
									...
									new GraphRequest.GraphJSONObjectCallback() {
										...
										public void onCompleted(
											...
											Log.e("jsonobjectresponse",object.toString());
											...
											try {
												...
												Log.e("fbLog", "id= "+id+" ,name= "+Name);

												ApplicationController.getInstance().fbId = object.getString("id");
												...
												if (object.has("email")){
                                                   ...
                                                   *//* alertDialog.setTitle("Alert");
													...
													//ApplicationController.getInstance().fbEmail = "empty";
				...
				.addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
					...
					//	Log.e("credential",""+credential.getSignInMethod());
						if (task.isSuccessful()) {
							...
							Log.e("fbuser",""+user.getDisplayName());
        //callfblogin

							SignInWithFacebook(user.getDisplayName()," ",ApplicationController.getInstance().fbEmail,ApplicationController.getInstance().fbId);


							Log.e("fbLogin",user.getDisplayName()+"."+ApplicationController.getInstance().fbEmail+ApplicationController.getInstance().fbId);
