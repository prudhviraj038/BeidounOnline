...
public class SchemeFragment extends Fragment {
	...
	TextView scheme_content_frag_tv;
	...
	public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
		...
		scheme_content_frag_tv = (TextView)view.findViewById(R.id.scheme_content_frag);


		try {
			scheme_content_frag_tv.setText(Html.fromHtml(ApplicationController.getInstance().settings.getString("scheme_content")));
